    ...
    public partial class AddAppointmentServiceTable : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Appointments_customerservices_ServiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppointmentServices_customerservices_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "customerservices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "Category", "Description", "Duration", "IsBundle", "Price", "ServiceName" },
                values: new object[] { 9999, "Bundle", "Internal service used to handle aggregated bookings and downpayment logic.", new TimeSpan(0, 0, 30, 0, 0), true, 650.00m, "Service Bundle Placeholder" });
